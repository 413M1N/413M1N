...
const products = [
  ...
  },
  {
    ...
    imageAlt: "Padded safety shoe,Padded insole,Microfiber leather,Steel mid-plate,Energy absorbing heel,Oil resistant,Steel toe,Has no laces.",
  },
  {
    id: 3,
          ...
          {products.map((product) => (
            <a key={product.id} href={product.href} className="group">
              <div className="w-full aspect-w-5 aspect-h-5 bg-gray-200 rounded-lg  xl:aspect-w-15 xl:aspect-h-15">
                <img src={products.imageSrc} alt={product.imageAlt} />
              </div>
