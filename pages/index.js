...
export default function Home() {
  return (
    <div className="relative bg-gray-50">
      <main className="lg:relative bg-teal-900">
        <div className="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
            <h1 className="text-3xl tracking-tight mb-4 font-medium sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl">
              <span className="inline-block xl:inline text-yellow-600 underline decoration-wavy underline-offset-4 decoration-2">
                SAFE APPARELS
              </span>{" "}
            </h1>
            ...
            <p className="mt-3 max-w-md mx-auto text-lg text-gray-50 sm:text-xl md:mt-5 md:max-w-3xl">
              ...
              Industry leading approach embracing best practices on a global
              level in selection, training and fit validation of PPE equipmen
            </p>
        ...
        <div className="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full mt-10">
          <Slider />
        </div>
      </main>
    </div>
