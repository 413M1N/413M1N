...
const products = [
  ...
  },
  {
    ...
    description:'Padded safety shoe,Padded insole,Microfiber leather,Steel mid-plate,Energy absorbing heel,Oil resistant,Steel toe,Has no laces',
    href: '#',
  ...
  },
  {
    ...
    description:'Breathable genuine leather,Steel toe,Steel plate,Oil & acid resistant,Energy absorbing heels,Padded insole with mesh lining',
    href: '',
  ...
  },
  {
    ...
    description:'Water-resistant, Microfiber leather,Steel toe & steel mid-plate,Oil,acid and slip-resistant,Energy absorbing heels,Padded insole,Has no laces',
    href: '#',
  ...
  },
  {
    ...
    description:'Breathable genuine leather with cool comfort technique,Non-safety toe & plate',
    href: '#',
  ...
  },
  {
    ...
    description:'Breathable genuine leather, Steel toe,Steel toe,Oil-resistant,Energy absorbing heels,Padded insole',
    href: '#',
  ...
  },
  {
    ...
    description:'Steel toe,Steel plate,Oil resistant,Breathable genuine leather with cool comfort technique.',
    href: '#',
  ...
  },
  {
    ...
    description:'Water-resistant full nubuck leather upper,Anti-magnetic and thermal insulated composite midsole,Ultra-light and extra-wide, Ankle protection,Slip-resistant,Anti-static,Electrostatic discharge,Antibacterial insole,',
    href: '#',
  ...
  },
   {
    ...
    description:'Steel toe,Steel plate,Oil resistant,Breathable genuine leather,Energy absorbing heels,Padded insole',
    href: '#',
  ...
  },
   {
    id: 12,
    name: 'Nurses Crocs',
    description:'Crocs Lock™ slip-resistant tread,Fully molded and easy to clean with soap and water,Enclosed toe design and thicker metatarsal area help protect foot from spills',
    href: '#',
  ...
  },
  {
    id: 13,
    name: 'Egoli Gumboots',
    description:'Heavy duty gumboot,Steel-toe,PVC water resistant,Anti-slip and anti-static sole',
    href: '#',
