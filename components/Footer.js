...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/safeapparels",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/safe_apparels/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <Image
              ...
              width="64"
            />
            <p className="text-teal-600 font-['Mochiy_Pop_P_One'] text-base">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-teal-600 tracking-wider uppercase">
                  Company
                </h3>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} Safe Apparels, Inc. All rights
            reserved.
          </p>
        </div>
      </div>
